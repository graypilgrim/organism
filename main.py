...
parser.add_argument("algorithm", type=int, choices=[0, 1], help="use on of the provided algorithms, 0 for (mu+lambda), 1 for (mu, lambda)")

args = parser.parse_args()
bodySize = args.bodySize
cellsNo = args.cellsNo
muPlusLambda = args.algorithm == 0

app = QtGui.QApplication(sys.argv)
view = View(bodySize)

algorithm = Algorithm(view, bodySize, cellsNo, muPlusLambda)
